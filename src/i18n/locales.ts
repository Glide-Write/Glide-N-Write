...
export const translations: Record<LanguageType, any> = {
  en: {
    ...
    main: { drafting: "Drafting...", existing: "Existing:", mapping: "Mapping", ttsError: "The voice package for this language is not installed on your device. Please install it from your device's text-to-speech settings." },
  ...
  tr: {
    ...
    main: { drafting: "Taslak...", existing: "Mevcut:", mapping: "Eşleniyor", ttsError: "Bu dilin ses paketi cihazınızda yüklü değil. Lütfen cihazınızın Metin Okuma ayarlarından yükleyin." },
    ...
    main: { drafting: "Luonnos...", existing: "Nykyinen:", mapping: "Kartoitus", ttsError: "Tämän kielen äänipakettia ei ole asennettu laitteellesi. Asenna se laitteesi Teksti puheeksi -asetuksista." },
  ...
  es: {
    ...
    main: { drafting: "Borrador...", existing: "Existente:", mapping: "Mapeando", ttsError: "El paquete de voz para este idioma no está instalado en su dispositivo. Instálelo desde la configuración de Texto a voz de su dispositivo." },
  ...
  zh: {
    ...
    header: { step: "分步", glide: "滑动", talkOn: "说话", entryOn: "输入" },
    settings: { appearance: "外观 (主题)", themes: { bone: "骨白", boneDesc: "暖光", oatmeal: "燕麦", oatmealDesc: "舒适", slate: "板岩", slateDesc: "冷灰", sage: "鼠尾草", sageDesc: "植物光", charcoal: "炭黑", charcoalDesc: "柔和暗色", midnight: "午夜", midnightDesc: "深海蓝" }, quickSymbols: "快捷符号", reset: "重置", done: "完成", edit: "编辑", uiLanguage: "界面语言", layerToggle: "图层切换", numberOfLayers: "图层数量", upTo4Dictionaries: "最多4个独立字典", showLayerToggle: "显示图层切换", leftSide: "左侧", rightSide: "右侧", inputStyle: "输入方式", inputStyleDesc: "在滑动和分步输入方式之间进行选择。" },
    configs: { editMapped: "编辑映射的序列", typeWord: "输入词语...", configTitle: "配置标题", description: "描述...", createNew: "创建新配置" },
    main: { drafting: "起草中...", existing: "现有的:", mapping: "映射中", ttsError: "您的设备上未安装此语言的语音包。请从设备的文本转语音设置中安装。" },
    bottomBar: { clear: "清除", undo: "撤销", type: "输入", speak: "说话" },
    modal: { mapAction: "映射操作", enterWord: "输入词语", typeYourWord: "输入你的词语...", cancel: "取消", save: "保存" },
    aboutPage: { title: "Glide & Write", version: "版本 1.0.0", p1: "Glide & Write 是一种创新且易于访问的文本输入系统，旨在通过定向滑动和分层字典配置使打字变得更简单、更快捷。", p2: "无论您是将其用于日常对话、专业术语还是无障碍交流，Glide & Write 都能通过完全可自定义的词集和直观的滑动控制适应您的需求。", contact: "联系方式", github: "GitHub", website: "网站", sponsors: "赞助商", noSponsors: "目前没有赞助商。", supportProject: "支持项目的发展并在这里占据一席之地。" },
    tutorial: {
  ...
  hi: {
    ...
    main: { drafting: "मसौदा तैयार किया जा रहा है...", existing: "मौजूदा:", mapping: "मैपिंग", ttsError: "इस भाषा के लिए ध्वनि पैकेज आपके डिवाइस पर स्थापित नहीं है। कृपया इसे अपने डिवाइस की टेक्स्ट-टू-स्पीच सेटिंग्स से स्थापित करें।" },
  ...
  ar: {
    ...
    main: { drafting: "صياغة...", existing: "حالي:", mapping: "تعيين", ttsError: "حزمة الصوت لهذه اللغة غير مثبتة على جهازك. يرجى تثبيتها من إعدادات تحويل النص إلى كلام بجهازك." },
  ...
  bn: {
    ...
    header: { step: "ধাপ", glide: "স্লাইড", talkOn: "কথা", entryOn: "এন্ট্রি" },
    settings: { appearance: "উপস্থিতি (থিম)", themes: { bone: "হাড়", boneDesc: "উষ্ণ আলো", oatmeal: "ওটমিল", oatmealDesc: "আরামদায়ক", slate: "স্লেট", slateDesc: "শীতল ধূসর", sage: "ঋষি", sageDesc: "বোটানিক আলো", charcoal: "কয়লা", charcoalDesc: "নরম অন্ধকার", midnight: "মধ্যরাত", midnightDesc: "গভীর নেভি" }, quickSymbols: "দ্রুত প্রতীক", reset: "রিসেট", done: "সম্পন্ন", edit: "সম্পাদনা", uiLanguage: "ইউআই ভাষা", layerToggle: "স্তর টগল", numberOfLayers: "স্তরের সংখ্যা", upTo4Dictionaries: "৪টি পর্যন্ত আলাদা অভিধান", showLayerToggle: "স্তর টগল দেখান", leftSide: "বাম দিক", rightSide: "ডান দিক", inputStyle: "ইনপুট শৈলী", inputStyleDesc: "গ্লাইড এবং স্টেপ ইনপুট পদ্ধতির মধ্যে বেছে নিন।" },
    ...
    main: { drafting: "খসড়া করা হচ্ছে...", existing: "বিদ্যমান:", mapping: "ম্যাপিং", ttsError: "এই ভাষার জন্য ভয়েস প্যাকেজটি আপনার ডিভাইসে ইনস্টল করা নেই। অনুগ্রহ করে আপনার ডিভাইসের টেক্সট-টু-স্পিচ সেটিংস থেকে এটি ইনস্টল করুন।" },
  ...
  ru: {
    ...
    main: { drafting: "Черновик...", existing: "Существующий:", mapping: "Назначение", ttsError: "Голосовой пакет для этого языка не установлен на вашем устройстве. Пожалуйста, установите его в настройках преобразования текста в речь вашего устройства." },
  ...
  pt: {
    ...
    header: { step: "Passo", glide: "Deslizar", talkOn: "Falar", entryOn: "Entrada" },
    settings: { appearance: "Aparência (Temas)", themes: { bone: "Osso", boneDesc: "Luz Quente", oatmeal: "Aveia", oatmealDesc: "Aconchegante", slate: "Ardósia", slateDesc: "Cinza Frio", sage: "Sálvia", sageDesc: "Luz Botânica", charcoal: "Carvão", charcoalDesc: "Escuro Suave", midnight: "Meia-noite", midnightDesc: "Azul Marinho" }, quickSymbols: "Símbolos Rápidos", reset: "Redefinir", done: "Concluído", edit: "Editar", uiLanguage: "Idioma da Interface", layerToggle: "Alternar Camada", numberOfLayers: "Número de Camadas", upTo4Dictionaries: "Até 4 dicionários separados", showLayerToggle: "Mostrar Alternância de Camada", leftSide: "Lado Esquerdo", rightSide: "Lado Direito", inputStyle: "Estilo de Entrada", inputStyleDesc: "Escolha entre os métodos de entrada de deslizar e de passo." },
    ...
    main: { drafting: "Rascunho...", existing: "Existente:", mapping: "Mapeando", ttsError: "O pacote de voz para este idioma não está instalado no seu dispositivo. Instale-o a partir das configurações de conversão de texto em voz do seu dispositivo." },
  ...
  fr: {
    ...
    header: { step: "Étape", glide: "Glisser", talkOn: "Parler", entryOn: "Saisie" },
    settings: { appearance: "Apparence (Thèmes)", themes: { bone: "Os", boneDesc: "Lumière Chaude", oatmeal: "Avoine", oatmealDesc: "Confortable", slate: "Ardoise", slateDesc: "Gris Froid", sage: "Sauge", sageDesc: "Lumière Botanique", charcoal: "Charbon", charcoalDesc: "Sombre Doux", midnight: "Minuit", midnightDesc: "Bleu Marine" }, quickSymbols: "Symboles Rapides", reset: "Réinitialiser", done: "Terminé", edit: "Modifier", uiLanguage: "Langue de l'interface", layerToggle: "Basculer de Calque", numberOfLayers: "Nombre de Calques", upTo4Dictionaries: "Jusqu'à 4 dictionnaires séparés", showLayerToggle: "Afficher le Basculement de Calque", leftSide: "Côté Gauche", rightSide: "Côté Droit", inputStyle: "Style de Saisie", inputStyleDesc: "Choisissez entre les méthodes de saisie par glissement et par étapes." },
    ...
    main: { drafting: "Brouillon...", existing: "Existant:", mapping: "Mappage", ttsError: "Le package vocal pour cette langue n'est pas installé sur votre appareil. Veuillez l'installer à partir des paramètres de synthèse vocale de votre appareil." },
    ...
    aboutPage: { title: "Glide & Write", version: "Version 1.0.0", p1: "Glide & Write est un système de saisie de texte innovant et accessible conçu pour rendre la frappe plus facile et plus rapide grâce au glissement directionnel et aux configurations de dictionnaire en couches.", p2: "Que vous l'utilisiez pour des conversations quotidiennes, une terminologie spécialisée ou une communication accessible, Glide & Write s'adapte à vos besoins avec des ensembles de mots entièrement personnalisables et des commandes de balayage intuitives.", contact: "Contact", github: "GitHub", website: "Site Web", sponsors: "Sponsors", noSponsors: "Actuellement aucun sponsor.", supportProject: "Soutenez le développement du projet et prenez votre place ici." },
    tutorial: {
  ...
  de: {
    ...
    header: { step: "Schritt", glide: "Gleiten", talkOn: "Sprechen", entryOn: "Eingabe" },
    settings: { appearance: "Erscheinungsbild (Themes)", themes: { bone: "Knochen", boneDesc: "Warmes Licht", oatmeal: "Haferflocken", oatmealDesc: "Gemütlich", slate: "Schiefer", slateDesc: "Kühles Grau", sage: "Salbei", sageDesc: "Botanisches Licht", charcoal: "Holzkohle", charcoalDesc: "Sanftes Dunkel", midnight: "Mitternacht", midnightDesc: "Tiefes Marineblau" }, quickSymbols: "Schnellsymbole", reset: "Zurücksetzen", done: "Fertig", edit: "Bearbeiten", uiLanguage: "Benutzeroberflächensprache", layerToggle: "Ebenenwechsel", numberOfLayers: "Anzahl der Ebenen", upTo4Dictionaries: "Bis zu 4 separate Wörterbücher", showLayerToggle: "Ebenenwechsel anzeigen", leftSide: "Linke Seite", rightSide: "Rechte Seite", inputStyle: "Eingabestil", inputStyleDesc: "Wählen Sie zwischen den Eingabemethoden Gleiten und Schritt." },
    ...
    main: { drafting: "Entwurf...", existing: "Vorhanden:", mapping: "Zuordnung", ttsError: "Das Sprachpaket für diese Sprache ist nicht auf Ihrem Gerät installiert. Bitte installieren Sie es über die Text-to-Speech-Einstellungen Ihres Geräts." },
